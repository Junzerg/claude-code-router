...
import { Settings, Languages, Save, RefreshCw, FileJson, CircleArrowUp, FileText, FileCog, LayoutDashboard } from "lucide-react";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
    ...
    <TooltipProvider>
      ...
      <header className="flex h-16 items-center justify-between border-b bg-white px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" onClick={() => navigate('/pool-status')} className="transition-all-ease hover:scale-110">
